...
onlinetweetsappv3 = Flask(__name__)
...
onlinetweetsappv3.vars = {}

onlinetweetsappv3.regions = {}
onlinetweetsappv3.regions['Which region would you like to select?']=('West USA','East USA')

@onlinetweetsappv3.route('/main', methods=['GET', 'POST'])
def main():
    if request.method == 'GET':
        a1, a2 = onlinetweetsappv3.regions.values()[0]
        return render_template('form.html', ans1=a1, ans2=a2)
    else:
        # request was a POST
        onlinetweetsappv3.vars['region'] = request.form['answer_from_layout']     
        return redirect('/graph')

@onlinetweetsappv3.route('/graph', methods=['GET', 'POST'])
def graph():    
    """AUTHENTICATION
    """
    ...
    def pick_location():
        ...
        '''
        bounding_box = ""
        if onlinetweetsappv3.vars['region'] == 'West USA':
    ...
    tit = onlinetweetsappv3.vars['region']
